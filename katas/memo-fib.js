 ...
 * as we calculate them. When a Fibonacci number is calculated, we first look it up 
 * in the cache, if it's not there, we calculate it and put it in the cache, 
 * otherwise we return the cached number.
 * 
 * Refactor the function into a recursive Fibonacci function that uses a memoized data 
 * structure avoids the deficiencies of tree recursion.
 * 
 ...
 */
 ...
 function fibonacci(n, cache={}) {
    if(n == 0 || n == 1) {
        cache[n] === undefined ? cache[n] = n : null;
        return cache[n];
    }
